...
extension AniTrackAPI {
  class SaveMyAnimeListEntryMutation: GraphQLMutation {
    static let operationName: String = "SaveMyAnimeListEntry"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation SaveMyAnimeListEntry($id: Int, $mediaId: Int, $status: MediaListStatus, $score: Float, $progress: Int, $startedAt: FuzzyDateInput, $completedAt: FuzzyDateInput) { SaveMediaListEntry( id: $id mediaId: $mediaId status: $status score: $score progress: $progress startedAt: $startedAt completedAt: $completedAt ) { __typename id status score progress startedAt { __typename year month day } completedAt { __typename year month day } media { __typename id episodes title { __typename romaji english userPreferred } coverImage { __typename extraLarge large } genres } } }"#
      ))
    ...
    struct Data: AniTrackAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        SaveMyAnimeListEntryMutation.Data.self
      ] }

      /// Create or update a media list entry
      var saveMediaListEntry: SaveMediaListEntry? { __data["SaveMediaListEntry"] }

      /// SaveMediaListEntry
      ///
      /// Parent Type: `MediaList`
      struct SaveMediaListEntry: AniTrackAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          SaveMyAnimeListEntryMutation.Data.SaveMediaListEntry.self
        ] }
        ...
        struct StartedAt: AniTrackAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            SaveMyAnimeListEntryMutation.Data.SaveMediaListEntry.StartedAt.self
          ] }
        ...
        struct CompletedAt: AniTrackAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            SaveMyAnimeListEntryMutation.Data.SaveMediaListEntry.CompletedAt.self
          ] }
        ...
        struct Media: AniTrackAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            SaveMyAnimeListEntryMutation.Data.SaveMediaListEntry.Media.self
          ] }
          ...
          /// SaveMediaListEntry.Media.Title
          ///
          ...
          struct Title: AniTrackAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              SaveMyAnimeListEntryMutation.Data.SaveMediaListEntry.Media.Title.self
            ] }
          ...
          /// SaveMediaListEntry.Media.CoverImage
          ///
          ...
          struct CoverImage: AniTrackAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              SaveMyAnimeListEntryMutation.Data.SaveMediaListEntry.Media.CoverImage.self
            ] }
