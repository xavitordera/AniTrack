...
extension AniTrackAPI {
  class MyAnimeListCollectionQuery: GraphQLQuery {
    static let operationName: String = "MyAnimeListCollection"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query MyAnimeListCollection { MediaListCollection(type: ANIME) { __typename lists { __typename name isCustomList status entries { __typename id status score progress startedAt { __typename year month day } completedAt { __typename year month day } media { __typename id episodes title { __typename romaji english userPreferred } coverImage { __typename extraLarge large } genres } } } } }"#
      ))
    ...
    struct Data: AniTrackAPI.SelectionSet {
      ...
      static var __selections: [ApolloAPI.Selection] { [
        .field("MediaListCollection", MediaListCollection?.self, arguments: ["type": "ANIME"]),
      ] }
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        MyAnimeListCollectionQuery.Data.self
      ] }
      ...
      struct MediaListCollection: AniTrackAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          MyAnimeListCollectionQuery.Data.MediaListCollection.self
        ] }
        ...
        struct List: AniTrackAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            MyAnimeListCollectionQuery.Data.MediaListCollection.List.self
          ] }
          ...
          struct Entry: AniTrackAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              MyAnimeListCollectionQuery.Data.MediaListCollection.List.Entry.self
            ] }
            ...
            struct StartedAt: AniTrackAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                MyAnimeListCollectionQuery.Data.MediaListCollection.List.Entry.StartedAt.self
              ] }
            ...
            struct CompletedAt: AniTrackAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                MyAnimeListCollectionQuery.Data.MediaListCollection.List.Entry.CompletedAt.self
              ] }
            ...
            struct Media: AniTrackAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                MyAnimeListCollectionQuery.Data.MediaListCollection.List.Entry.Media.self
              ] }
              ...
              /// MediaListCollection.List.Entry.Media.Title
              ///
              ...
              struct Title: AniTrackAPI.SelectionSet {
                ...
                static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                  MyAnimeListCollectionQuery.Data.MediaListCollection.List.Entry.Media.Title.self
                ] }
              ...
              struct CoverImage: AniTrackAPI.SelectionSet {
                ...
                static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                  MyAnimeListCollectionQuery.Data.MediaListCollection.List.Entry.Media.CoverImage.self
                ] }
